import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import Database from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/better-sqlite3@11.7.2/node_modules/better-sqlite3/lib/index.js';
import { isAbsolute } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/pathe@1.1.2/node_modules/pathe/dist/index.mjs';
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, eventHandler, getRouterParam, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, readValidatedBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/h3@1.13.0/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/devalue@5.1.1/node_modules/devalue/index.js';
import destr from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/destr@2.0.3/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/ufo@1.5.4/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/vue@3.5.13_typescript@5.6.3/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/@unhead+ssr@1.11.15/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/unenv@1.10.0/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/unstorage@1.14.4_db0@0.2.1_@libsql+client@0.14.0_better-sqlite3@11.7.2__ioredis@5.4.2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/unstorage@1.14.4_db0@0.2.1_@libsql+client@0.14.0_better-sqlite3@11.7.2__ioredis@5.4.2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/consola@3.3.3/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/vue@3.5.13_typescript@5.6.3/node_modules/vue/index.mjs';
import { z } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/zod@3.24.1/node_modules/zod/lib/index.mjs';
import { hash } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/ohash@1.1.4/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/unhead@1.11.15/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/mrobeidat/Desktop/blog/node_modules/.pnpm/@unhead+shared@1.11.15/node_modules/@unhead/shared/dist/index.mjs';
...
const _56Yw7XJZGj = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/mrobeidat/Desktop/blog";
...
const _Z0bS9t = eventHandler(async (event) => {
  const collection = getRouterParam(event, "collection");
  return await import('file:///home/mrobeidat/Desktop/blog/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/mrobeidat/Desktop/blog/.data/content/contents.sqlite"
    }
  }
};
const envOptions = {
...
const serverAssets = [{"baseName":"server","dir":"/home/mrobeidat/Desktop/blog/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/mrobeidat/Desktop/blog","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/mrobeidat/Desktop/blog/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/mrobeidat/Desktop/blog/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/mrobeidat/Desktop/blog/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mrobeidat/Desktop/blog/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _vyg5m3 = eventHandler(async (event) => {
...
const _lazy_6gBOSU = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6gBOSU, lazy: true, middleware: false, method: undefined },
  { route: '/api/content/:collection/database.sql', handler: _Z0bS9t, lazy: false, middleware: false, method: undefined },
  { route: '/api/content/:collection/query', handler: _vyg5m3, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6gBOSU, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/mrobeidat/Desktop/blog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/mrobeidat/Desktop/blog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
